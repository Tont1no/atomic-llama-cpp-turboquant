...
// blockwise Hadamard rotation (PrismML prism.hadamard GGUFs, e.g. Bonsai 2).
...
public:
    ...
    ggml_tensor * rp_idx       = nullptr; // I32 [3, n_seqs] (source cell, replayed tokens, destination cell)
...
struct llm_graph_context {
    ...
    // the activation a folded weight expects (signs, rotation); `cur` otherwise
