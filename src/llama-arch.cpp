...
static const std::map<llm_kv, const char *> LLM_KV_NAMES = {
    ...
    { LLM_KV_DFLASH_STACKED_KV_MIN_ROWS, "%s.stacked_kv_min_rows" },
...
static const std::map<llm_tensor, const char *> LLM_TENSOR_NAMES = {
    ...
    { LLM_TENSOR_DFLASH_ATTN_KV_STACKED,                  "dflash.attn_kv_stacked" },
...
static const std::map<llm_tensor, llm_tensor_info> LLM_TENSOR_INFOS = {
    ...
    {LLM_TENSOR_DFLASH_ATTN_KV_STACKED,      {LLM_TENSOR_LAYER_OUTPUT,    GGML_OP_MUL_MAT}},
