...
struct llama_context {
    ...
    llama_state_seq_snapshot * state_seq_snapshot_create(llama_seq_id seq_id, size_t max_bytes);
...
private:
    ...
    // paged C1: one selection per sequence whose prompt ended in the ubatch
