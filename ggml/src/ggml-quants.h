...
GGML_API void quantize_row_turbo3_5_ref(const float * GGML_RESTRICT x, block_turbo3_5 * GGML_RESTRICT y, int64_t k);
...
GGML_API void dequantize_row_turbo3_5(const block_turbo3_5 * GGML_RESTRICT x, float * GGML_RESTRICT y, int64_t k);
...
GGML_API size_t quantize_turbo3_5(const float * GGML_RESTRICT src, void * GGML_RESTRICT dst, int64_t nrows, int64_t n_per_row, const float * imatrix);
