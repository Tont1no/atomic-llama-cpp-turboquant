...
void ggml_compute_forward_pyramidkv_quest_update(const struct ggml_compute_params * params, struct ggml_tensor * dst);
void ggml_compute_forward_pyramidkv_quest_select(const struct ggml_compute_params * params, struct ggml_tensor * dst);
